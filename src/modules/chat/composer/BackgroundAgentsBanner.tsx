...
type BackgroundAgentsBannerProps = {
  agents: RunningBackgroundAgent[];
}

/**
 * Used by ChatComposer. Surfaces subagents that are still working, mirroring the CLI's status line.
 *
...
export default function BackgroundAgentsBanner({ agents }: BackgroundAgentsBannerProps) {
  ...
  // Refreshes elapsed durations while agents are running.
